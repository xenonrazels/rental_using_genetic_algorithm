    ...
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li><a href="recommendation.php" target="_self">For Recommendation</a></li>
        </ul>
      </div>
...
<section class="fun-facts-section">
  ...
  <!-- Button to trigger recommendation.php -->
  <!-- <div class="container">
    ...
    <form action="recommendation.php" method="get">
      <div class="input-container">
        ...
        <button class="get-recommendation-button" type="submit">Get Recommendations</button>
      </div>
    </form>
  </div> -->
  <!-- Dark Overlay-->
